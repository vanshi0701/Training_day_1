...
- High School: BCM School, Dugri, Ludhiana, Punjab  
...
-> Skills required:
   ...
   - UI/Frontend Development: Basic HTML, CSS, JavaScript for clean interfaces.
...
-> How to solve:
   ...
   - Manage time wisely—don’t chase perfection.
